...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        var funcionarioLog = new FuncionarioLog(funcionarioBanco, TipoAcao.Atualizacao, funcionarioBanco.Departamento, Guid.NewGuid().ToString());
         ...
         funcionarioLog.Nome = funcionario.Nome;
           funcionarioLog.Endereco = funcionario.Endereco;
           funcionarioLog.Ramal = funcionario.Ramal;
           funcionarioLog.EmailProfissional = funcionario.EmailProfissional;
            funcionarioLog.Departamento = funcionario.Departamento;
           funcionarioLog.Salario = funcionario.Salario;
        funcionarioLog.DataAdmissao = funcionario.DataAdmissao;
        // TODO: Chamar o método UpsertEntity para salvar no Azure Table
        tableClient.UpsertEntity(funcionarioLog);
